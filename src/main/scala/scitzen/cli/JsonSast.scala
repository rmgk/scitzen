...
import scitzen.semantics.Sast.{AttributeDef, AttributedBlock, MacroBlock, ParsedBlock, RawBlock, Section, Sections, Slist, SlistItem, Text}
...
object JsonSast {
  ...
  implicit val SseqfEncoder          : Writer[Sections]        = macroW
